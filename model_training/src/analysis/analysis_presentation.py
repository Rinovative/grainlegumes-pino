...
EDA_SECTIONS = (
    ...
    SectionPresentation(
        ...
        plots=(
            ...
            PlotPresentation("directional_spectra", "Directional spectra and cumulative energy"),
            PlotPresentation("spectral_evolution", "Horizontal spectral evolution with height"),
        ),
    ),
)
